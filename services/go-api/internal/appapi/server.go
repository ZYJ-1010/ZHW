...
func (s *Server) Register(mux *http.ServeMux) {
	...
	handle("GET /api/app/games/create-template-config", s.AppAuthMiddleware(s.gameCreateTemplateConfigHandler))
	...
	handle("GET /api/app/enterprise-certification", s.AppAuthMiddleware(s.appEnterpriseCertification))
	handle("POST /api/app/enterprise-certification", s.AppAuthMiddleware(s.IdempotencyMiddleware(s.submitEnterpriseCertification)))
	...
	handle("GET /api/admin/games/create-template-config", s.requireAdminPermission("system_config:read", s.adminGameCreateTemplateConfig))
	handle("PUT /api/admin/games/create-template-config", s.requireAdminPermission("system_config:update", s.adminGameCreateTemplateConfig))
	...
	handle("GET /api/admin/enterprise-certifications", s.requireAdminPermission("identity:read", s.adminEnterpriseCertifications))
	handle("GET /api/admin/enterprise-certifications/", s.requireAdminPermission("identity:read", s.adminEnterpriseCertificationDetail))
	handle("POST /api/admin/enterprise-certifications/", s.requireAdminPermission("identity:update", s.routeAdminEnterpriseCertificationPost))
