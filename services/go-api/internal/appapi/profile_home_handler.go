...
func (s *Server) buildProfileHomePayload(userID int64, user users.User, current CurrentUserDTO, reviewTodoCount int) map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"stats": []map[string]interface{}{
			{"key": "referrals", "label": "引荐数", "value": strconv.Itoa(len(conns))},
			{"key": "successes", "label": "成功数", "value": strconv.Itoa(countStrongConnections(conns))},
		...
		"serviceSections": s.profileHomeSections(reviewTodoCount, notifications, len(conns)),
...
func (s *Server) profileHomeSections(reviewTodoCount int, unreadCount int, connectionCount int) []map[string]interface{} {
	return []map[string]interface{}{
		{
			"title": "服务中心",
			"items": []map[string]interface{}{
				profileHomeItem("myGames", "我的局", "/pages/profile/assets/i66@3x.png", "purple-blue", "2进行中", "pink", "/pages/profile/service-center/my-games/index"),
