...
func TestGameDetailPrimaryActionByStatusAndRelation(t *testing.T) {
	tests := []struct {
		...
		{name: "application pending", status: "recruiting", relation: GameMyRelationDTO{Role: "guest", ApplicationStatus: "pending"}, text: "申请中", action: "none", disabled: true},
		{name: "member waits", status: "recruiting", relation: GameMyRelationDTO{IsMember: true}, text: "已入局", action: "none", disabled: true},
		...
		{name: "full member waits", status: "full", relation: GameMyRelationDTO{IsMember: true}, text: "已入局", action: "none", disabled: true},
		...
		{name: "member confirms completion", status: "pending_confirm", relation: GameMyRelationDTO{IsMember: true, CanConfirm: true}, text: "确认完成", action: "confirm", routePart: "delivery"},
