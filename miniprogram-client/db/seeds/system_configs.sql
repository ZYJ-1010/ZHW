  ...
  (
    ...
    '{
      ...
      "typeFilters": [
        ...
        { "key": "condition", "name": "条件局", "visible": true, "order": 30, "selectable": true }
      ],
      "locationFilters": [
      ...
      "storyGroups": [
        {
          "year": 2024,
          "stories": [
            { "id": "countdown-night", "tag": "最难忘", "tagTone": "gold", "title": "跨年夜的倒计时", "date": "12.31", "sortDate": "2024-12-31", "location": "", "cover": "https://static.haowan.net.cn/miniprogram/pages/map/my-city/assets/story-river-cover.png", "coverLocation": "上海 · 外滩", "desc": "和刚认识的摄影局朋友们一起在外滩等待新年钟声。江风吹得发抖，但倒数的那一刻，所有的陌生人都变成了朋友。", "participants": ["a", "b", "c"], "badgeTitle": "", "badgeDesc": "", "actionText": "", "actionTone": "" },
