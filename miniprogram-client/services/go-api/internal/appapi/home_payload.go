...
func homeGameCover(index int) string {
	covers := []string{
		"https://static.haowan.net.cn/miniprogram/components/game-card/assets/cover-city.png",
		"https://static.haowan.net.cn/miniprogram/assets/game-card/cover-sunset.png",
	}
