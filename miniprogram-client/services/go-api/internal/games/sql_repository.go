...
insert into game_applications (game_id, user_id, status, reason, file_ids, created_at)
values ($1,$2,$3,$4,$5,$6)
returning id, game_id, user_id, status, reason, file_ids, created_at
`, application.GameID, application.UserID, application.Status, application.Reason, string(fileIDs), application.CreatedAt))
}
...
select id, game_id, user_id, status, reason, file_ids, created_at
...
func (r *SQLRepository) ListApplicationsForCreator(ctx context.Context, creatorUserID int64) ([]Application, error) {
	rows, err := r.db.QueryContext(ctx, `
select a.id, a.game_id, a.user_id, a.status, a.reason, a.file_ids, a.created_at
...
insert into game_invitations (
  game_id, inviter_user_id, target_user_id, status, message, application_id, created_at, responded_at
) values ($1,$2,$3,$4,$5,$6,$7,$8)
returning id, game_id, inviter_user_id, target_user_id, status, message, application_id, created_at, responded_at
`, invitation.GameID, invitation.InviterID, invitation.TargetUserID, invitation.Status, nullString(invitation.Message),
...
where id = $1
returning id, game_id, inviter_user_id, target_user_id, status, message, application_id, created_at, responded_at
`, invitation.ID, invitation.Status, nullString(invitation.Message),
		nullInt64(invitation.ApplicationID), nullTimeString(invitation.RespondedAt)))
}
...
select id, game_id, inviter_user_id, target_user_id, status, message, application_id, created_at, responded_at
