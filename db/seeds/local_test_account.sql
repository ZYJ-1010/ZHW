...
with upsert_user as (
  ...
  values (
    ...
    'active',
    '本机测试行家领路人',
    'mock://avatar/local-expert-guide.png',
    '138****0001',
    'verified',
    now(),
    now()
...
values
  (10001, 'expert', 'approved', '本机测试行家身份', '用于本机测试行家页面、行家服务和组局能力。', '[]'::jsonb, 1, 'local seed approved', now(), now()),
  (10001, 'guide', 'approved', '本机测试领路人身份', '用于本机测试领路人页面、主行家/主领路人相关能力。', '[]'::jsonb, 1, 'local seed approved', now(), now())
